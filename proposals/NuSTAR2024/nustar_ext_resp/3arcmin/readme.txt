...
a ~294 ks observation of Cassiopeia A. The ARF was generated using
the "extended" source option for the 3 arcminute radius circle centered
on Cas A with the optical axis roughly centered on the SNR. These response
files are for ONE of the two NuSTAR telescopes.
...
extended_3arcminRad.arf =
	"Extended" object with an extraction radius of 3 arcminute
bgd_3arcmin.pha = background from a 3 arcminute radius extraction region.
...
For fake spectrum #1 response file is needed: nustar.rmf
   ...and ancillary file: 3arcminA.arf
...
XSPEC12> backgrnd bgd_3arcminA.pha
